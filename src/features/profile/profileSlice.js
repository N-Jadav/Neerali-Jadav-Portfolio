  ...
  experience: [
    {
      ...
      description:
        "Led high-impact projects by aligning team strengths, accelerating delivery, and driving clear communication with leadership. Engineered large-scale data migration using Kafka and Node.js for fast, reliable processing of massive datasets.",
    ...
    },
    {
      ...
      description:
        "Developed dynamic dashboards and automated data analysis tools that boosted stakeholder decision-making and increased productivity by 34%. Streamlined complex data-migration workflows with custom transformation logic, significantly reducing manual effort and accelerating report delivery.",
...

    {
      ...
      description:
        "Architected and deployed a cutting-edge truck tracking and route planning platform that directly achieved a 20% increase in operational efficiency and minimized delivery times. Engineered advanced optimization algorithms to maximize load distribution, enhancing resource utilization by 12%.",
    ...
    },
    {
      ...
      description:
        "Launched a full-featured online medical consultation platform (appointment booking, chat, image uploads) that rapidly onboarded 120 doctors and served hundreds of patients daily within the first week of release.",
